...
class cpl_add(val width: Int, val fracBits: Int) extends Module {
  val io = IO(new Bundle {
    val a = Input(new ComplexFP(width, fracBits))
    val b = Input(new ComplexFP(width, fracBits))
    val out = Output(new ComplexFP(width, fracBits))
  })

  io.out := io.a + io.b
}

class cpl_sub(val width: Int, val fracBits: Int) extends Module {
  val io = IO(new Bundle {
    val a = Input(new ComplexFP(width, fracBits))
    val b = Input(new ComplexFP(width, fracBits))
    val out = Output(new ComplexFP(width, fracBits))
...
class cpl_mul(val width: Int, val fracBits: Int) extends Module {
  val io = IO(new Bundle {
    val a = Input(new ComplexFP(width, fracBits))
    val b = Input(new ComplexFP(width, fracBits))
    val out = Output(new ComplexFP(width, fracBits))
...
class cpl_div(val width: Int, val fracBits: Int) extends Module {
  val io = IO(new Bundle {
    val a = Input(new ComplexFP(width, fracBits))
    val b = Input(new ComplexFP(width, fracBits))
    val out = Output(new ComplexFP(width, fracBits))
...
class cpl_times_real(val width: Int, val fracBits: Int) extends Module {
  val io = IO(new Bundle {
    val a = Input(new ComplexFP(width, fracBits))
    val b = Input(FixedPoint(width.W, fracBits.BP))
    val out = Output(new ComplexFP(width, fracBits))
...
class real_trans_cpl(val width: Int, val fracBits: Int) extends Module {
  val io = IO(new Bundle {
...
class Pow(val width: Int, val fracBits: Int) extends Module {
  val io = IO(new Bundle {
...
class Exp(val width: Int, val fracBits: Int) extends Module {
  val io = IO(new Bundle {
    val x = Input(FixedPoint(width.W, fracBits.BP))
    val start = Input(Bool())
    val res = Output(FixedPoint(width.W, fracBits.BP))
  ...
  val pow = Module(new Pow(width, fracBits))
